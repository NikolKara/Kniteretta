...
{
    public class KniterettaComponent : GH_Component
    {
        /// <summary>
        ...
        /// </summary>
        public KniterettaComponent()
          : base("Kniteretta", "ASpi",
        ...
        /// </summary>
        public override Guid ComponentGuid => new Guid("68272728-ee1f-4537-9139-e3fb73bdc0e6");
    }
}